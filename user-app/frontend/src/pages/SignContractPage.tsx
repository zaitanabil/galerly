...
export default function SignContractPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F5F5F7] py-12 px-4">
      ...
      {/* Branding footer - only show if photographer has free plan */}
      {/* Note: We'd need to fetch photographer's plan to conditionally show this */}
      {/* For now, this is always shown - should be conditionally rendered based on plan */}
