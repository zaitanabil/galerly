...
def get_email_footer():
    """Generate email footer with dynamic URLs from environment"""
    ...
    <div class="email-footer">
      ...
      <div class="email-footer-text" style="margin-top: 16px;">
        <a href="{website_url}" class="email-footer-link">galerly.com</a>
      </div>
      <div class="email-footer-text" style="margin-top: 12px;">
        <a href="{website_url}/privacy" class="email-footer-link">Privacy Policy</a>
        &nbsp;•&nbsp;
        <a href="{website_url}/legal-notice" class="email-footer-link">Legal Notice</a>
      </div>
    </div>
    '''
...
<p class="email-alert-text">Your gallery will expire soon!</p>
</div>
...
<p class="email-info-item"><strong>Archive Period:</strong> 30 days</p>
...
<p class="email-info-item"><strong>Action Required:</strong> All photos and data have been permanently removed.</p>
