...
class CloudFrontOptimizer:
    ...
    def __init__(self):
        self.cloudfront_client = boto3.client('cloudfront', region_name=os.environ.get('AWS_REGION'))
        ...
        return {
            ...
            'CorsConfig': {
                ...
                'Items': [
                    ...
                    f"www.{os.environ.get('WEBSITE_URL').replace('https://', '')}"
                ]
            },
    ...
    def get_origin_config(self):
        ...
        """
        bucket_name = os.environ.get('S3_PHOTOS_BUCKET')
