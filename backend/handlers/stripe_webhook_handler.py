...
def handle_stripe_webhook(event, context):
    ...
    try:
        ...
        if STRIPE_WEBHOOK_SECRET and sig_header:
            ...
            print(f"⚠️  Skipping signature verification (local dev)")
    ...
    if event_type == 'invoice.paid':
        ...
        try:
            ...
            if user_response.get('Items'):
                ...
                print(f"✅ Billing record created: {billing_id}")
            else:
        ...
        print(f"⚠️  Payment action required")
