/**
 * Infinite Scroll Pagination for Gallery Photos
...
class InfiniteScrollGallery {
    ...
    async loadMore() {
        ...
        try {
            ...
            let url = `galleries/${this.galleryId}?page_size=${this.pageSize}`;
            if (this.nextKey) {
    ...
    showError() {
        ...
        errorElement.innerHTML = `
            ...
            <button class="retry-button" onclick="window.galleryScroller.loadMore()">Try Again</button>
        `;
...
window.InfiniteScrollGallery = InfiniteScrollGallery;
